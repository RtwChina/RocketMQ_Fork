...
// 对应一个 commitLog/ConsumerQueue 的内存映射
public class MappedFile extends ReferenceResource {
    ...
    // 将当前映射文件全部的地址空间锁定在物理存储中，防止其他被交换到SWAP空间
    public void mlock() {
