...
public class RouteInfoManager {
    ...
    // BrokerData里面有可能是主从模式，虽然是多台机器，但是主从模式的意思是多台机器的数据完全一致。
    private final HashMap<String/* brokerName */, BrokerData> brokerAddrTable;

    // 代码@5，clusterAddrTable，broker集群信息，每个集群包含哪些Broker。
    private final HashMap<String/* clusterName 集群名称*/, Set<String/* brokerName */>> clusterAddrTable;
    ...
    // 注册Broker， 在NameSrv获取到Broker的心跳信息的时候，会调用。
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                ...
                // 先查看以clusterName，是否存在集群，如果没有则创建一个
